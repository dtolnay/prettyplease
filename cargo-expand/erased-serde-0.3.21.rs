...
#![allow(clippy :: derive_partial_eq_without_eq, clippy ::
items_after_statements, clippy :: manual_map, clippy :: missing_errors_doc,
clippy :: needless_doctest_main, clippy :: semicolon_if_nothing_returned,
clippy :: unused_self, clippy :: wildcard_imports)]
#[prelude_import]
...
mod any {
    ...
    impl Any {
        ...
        pub(crate) unsafe fn view<T>(&mut self) -> &mut T {
            ...
            let ptr =
                if is_small::<T>() {
                    ...
                    } else { unsafe { self.value.ptr as *mut T } };
            unsafe { &mut *ptr }
        }
        ...
        fn invalid_cast_to<T>(&self) -> ! {
            {
                ::std::rt::begin_panic("invalid cast; enable `unstable-debug` feature to debug")
            };
        }
    }
    impl Drop for Any {
        fn drop(&mut self) { unsafe { (self.drop)(&mut self.value) } }
    }
    struct Fingerprint {
        size: usize,
        align: usize,
...
mod de {
    ...
    /// }
    /// ```
    pub fn deserialize<'de, T>(deserializer: &mut dyn Deserializer<'de>)
        -> Result<T, Error> where T: serde::Deserialize<'de> {
        serde::Deserialize::deserialize(deserializer)
    }
    pub trait DeserializeSeed<'de> {
        fn erased_deserialize_seed(&mut self, d: &mut dyn Deserializer<'de>)
        -> Result<Out, Error>;
    }
    ...
    pub trait Deserializer<'de> {
        fn erased_deserialize_any(&mut self, v: &mut dyn Visitor<'de>)
        -> Result<Out, Error>;
        fn erased_deserialize_bool(&mut self, v: &mut dyn Visitor<'de>)
        -> Result<Out, Error>;
        fn erased_deserialize_u8(&mut self, v: &mut dyn Visitor<'de>)
        -> Result<Out, Error>;
        fn erased_deserialize_u16(&mut self, v: &mut dyn Visitor<'de>)
        -> Result<Out, Error>;
        fn erased_deserialize_u32(&mut self, v: &mut dyn Visitor<'de>)
        -> Result<Out, Error>;
        fn erased_deserialize_u64(&mut self, v: &mut dyn Visitor<'de>)
        -> Result<Out, Error>;
        fn erased_deserialize_i8(&mut self, v: &mut dyn Visitor<'de>)
        -> Result<Out, Error>;
        fn erased_deserialize_i16(&mut self, v: &mut dyn Visitor<'de>)
        -> Result<Out, Error>;
        fn erased_deserialize_i32(&mut self, v: &mut dyn Visitor<'de>)
        -> Result<Out, Error>;
        fn erased_deserialize_i64(&mut self, v: &mut dyn Visitor<'de>)
        -> Result<Out, Error>;
        fn erased_deserialize_i128(&mut self, v: &mut dyn Visitor<'de>)
        -> Result<Out, Error>;
        fn erased_deserialize_u128(&mut self, v: &mut dyn Visitor<'de>)
        -> Result<Out, Error>;
        fn erased_deserialize_f32(&mut self, v: &mut dyn Visitor<'de>)
        -> Result<Out, Error>;
        fn erased_deserialize_f64(&mut self, v: &mut dyn Visitor<'de>)
        -> Result<Out, Error>;
        fn erased_deserialize_char(&mut self, v: &mut dyn Visitor<'de>)
        -> Result<Out, Error>;
        fn erased_deserialize_str(&mut self, v: &mut dyn Visitor<'de>)
        -> Result<Out, Error>;
        fn erased_deserialize_string(&mut self, v: &mut dyn Visitor<'de>)
        -> Result<Out, Error>;
        fn erased_deserialize_bytes(&mut self, v: &mut dyn Visitor<'de>)
        -> Result<Out, Error>;
        fn erased_deserialize_byte_buf(&mut self, v: &mut dyn Visitor<'de>)
        -> Result<Out, Error>;
        fn erased_deserialize_option(&mut self, v: &mut dyn Visitor<'de>)
        -> Result<Out, Error>;
        fn erased_deserialize_unit(&mut self, v: &mut dyn Visitor<'de>)
        -> Result<Out, Error>;
        fn erased_deserialize_unit_struct(&mut self, name: &'static str,
        v: &mut dyn Visitor<'de>)
        -> Result<Out, Error>;
        fn erased_deserialize_newtype_struct(&mut self, name: &'static str,
        v: &mut dyn Visitor<'de>)
        -> Result<Out, Error>;
        fn erased_deserialize_seq(&mut self, v: &mut dyn Visitor<'de>)
        -> Result<Out, Error>;
        fn erased_deserialize_tuple(&mut self, len: usize,
        v: &mut dyn Visitor<'de>)
        -> Result<Out, Error>;
        fn erased_deserialize_tuple_struct(&mut self, name: &'static str,
        len: usize, v: &mut dyn Visitor<'de>)
        -> Result<Out, Error>;
        fn erased_deserialize_map(&mut self, v: &mut dyn Visitor<'de>)
        -> Result<Out, Error>;
        fn erased_deserialize_struct(&mut self, name: &'static str,
        fields: &'static [&'static str], v: &mut dyn Visitor<'de>)
        -> Result<Out, Error>;
        fn erased_deserialize_identifier(&mut self, v: &mut dyn Visitor<'de>)
        -> Result<Out, Error>;
        fn erased_deserialize_enum(&mut self, name: &'static str,
        variants: &'static [&'static str], v: &mut dyn Visitor<'de>)
        -> Result<Out, Error>;
        fn erased_deserialize_ignored_any(&mut self, v: &mut dyn Visitor<'de>)
        -> Result<Out, Error>;
        fn erased_is_human_readable(&self)
        -> bool;
    }
    pub trait Visitor<'de> {
        fn erased_expecting(&self, formatter: &mut fmt::Formatter)
        -> fmt::Result;
        fn erased_visit_bool(&mut self, v: bool)
        -> Result<Out, Error>;
        fn erased_visit_i8(&mut self, v: i8)
        -> Result<Out, Error>;
        fn erased_visit_i16(&mut self, v: i16)
        -> Result<Out, Error>;
        fn erased_visit_i32(&mut self, v: i32)
        -> Result<Out, Error>;
        fn erased_visit_i64(&mut self, v: i64)
        -> Result<Out, Error>;
        fn erased_visit_u8(&mut self, v: u8)
        -> Result<Out, Error>;
        fn erased_visit_u16(&mut self, v: u16)
        -> Result<Out, Error>;
        fn erased_visit_u32(&mut self, v: u32)
        -> Result<Out, Error>;
        fn erased_visit_u64(&mut self, v: u64)
        -> Result<Out, Error>;
        fn erased_visit_i128(&mut self, v: i128)
        -> Result<Out, Error>;
        fn erased_visit_u128(&mut self, v: u128)
        -> Result<Out, Error>;
        fn erased_visit_f32(&mut self, v: f32)
        -> Result<Out, Error>;
        fn erased_visit_f64(&mut self, v: f64)
        -> Result<Out, Error>;
        fn erased_visit_char(&mut self, v: char)
        -> Result<Out, Error>;
        fn erased_visit_str(&mut self, v: &str)
        -> Result<Out, Error>;
        fn erased_visit_borrowed_str(&mut self, v: &'de str)
        -> Result<Out, Error>;
        #[cfg(any(feature = "std", feature = "alloc"))]
        fn erased_visit_string(&mut self, v: String)
        -> Result<Out, Error>;
        fn erased_visit_bytes(&mut self, v: &[u8])
        -> Result<Out, Error>;
        fn erased_visit_borrowed_bytes(&mut self, v: &'de [u8])
        -> Result<Out, Error>;
        #[cfg(any(feature = "std", feature = "alloc"))]
        fn erased_visit_byte_buf(&mut self, v: Vec<u8>)
        -> Result<Out, Error>;
        fn erased_visit_none(&mut self)
        -> Result<Out, Error>;
        fn erased_visit_some(&mut self, d: &mut dyn Deserializer<'de>)
        -> Result<Out, Error>;
        fn erased_visit_unit(&mut self)
        -> Result<Out, Error>;
        fn erased_visit_newtype_struct(&mut self,
        d: &mut dyn Deserializer<'de>)
        -> Result<Out, Error>;
        fn erased_visit_seq(&mut self, s: &mut dyn SeqAccess<'de>)
        -> Result<Out, Error>;
        fn erased_visit_map(&mut self, m: &mut dyn MapAccess<'de>)
        -> Result<Out, Error>;
        fn erased_visit_enum(&mut self, e: &mut dyn EnumAccess<'de>)
        -> Result<Out, Error>;
    }
    pub trait SeqAccess<'de> {
        fn erased_next_element(&mut self, d: &mut dyn DeserializeSeed<'de>)
        -> Result<Option<Out>, Error>;
        fn erased_size_hint(&self)
        -> Option<usize>;
    }
    pub trait MapAccess<'de> {
        fn erased_next_key(&mut self, d: &mut dyn DeserializeSeed<'de>)
        -> Result<Option<Out>, Error>;
        fn erased_next_value(&mut self, d: &mut dyn DeserializeSeed<'de>)
        -> Result<Out, Error>;
        fn erased_next_entry(&mut self, key: &mut dyn DeserializeSeed<'de>,
    ...
    pub trait EnumAccess<'de> {
        fn erased_variant_seed(&mut self, d: &mut dyn DeserializeSeed<'de>)
    ...
    impl<'de> dyn Deserializer<'de> {
        ...
        /// }
        /// ```
        pub fn erase<D>(deserializer: D) -> erase::Deserializer<D> where
    ...
    pub struct Out(Any);
    impl Out {
        unsafe fn new<T>(t: T) -> Self { Out(unsafe { Any::new(t) }) }
        unsafe fn take<T>(self) -> T { unsafe { self.0.take() } }
    }
    mod erase {
        ...
        impl<D> DeserializeSeed<D> {
            pub(crate) fn take(&mut self) -> D { self.state.take().unwrap() }
        }
        ...
        impl<D> Deserializer<D> {
            pub(crate) fn take(&mut self) -> D { self.state.take().unwrap() }
            pub(crate) fn as_ref(&self) -> &D { self.state.as_ref().unwrap() }
        }
        ...
        impl<D> SeqAccess<D> {
            pub(crate) fn as_ref(&self) -> &D { &self.state }
            pub(crate) fn as_mut(&mut self) -> &mut D { &mut self.state }
        }
    ...
    impl<'de, T> DeserializeSeed<'de> for erase::DeserializeSeed<T> where
        T: serde::de::DeserializeSeed<'de> {
        fn erased_deserialize_seed(&mut self,
            deserializer: &mut dyn Deserializer<'de>) -> Result<Out, Error> {
            unsafe {
                self.take().deserialize(deserializer).unsafe_map(Out::new)
            }
        }
    }
    impl<'de, T> Deserializer<'de> for erase::Deserializer<T> where
        T: serde::Deserializer<'de> {
        fn erased_deserialize_any(&mut self, visitor: &mut dyn Visitor<'de>)
            -> Result<Out, Error> {
            self.take().deserialize_any(visitor).map_err(erase)
        }
        fn erased_deserialize_bool(&mut self, visitor: &mut dyn Visitor<'de>)
            -> Result<Out, Error> {
            self.take().deserialize_bool(visitor).map_err(erase)
        }
        fn erased_deserialize_u8(&mut self, visitor: &mut dyn Visitor<'de>)
            -> Result<Out, Error> {
            self.take().deserialize_u8(visitor).map_err(erase)
        }
        fn erased_deserialize_u16(&mut self, visitor: &mut dyn Visitor<'de>)
            -> Result<Out, Error> {
            self.take().deserialize_u16(visitor).map_err(erase)
        }
        fn erased_deserialize_u32(&mut self, visitor: &mut dyn Visitor<'de>)
            -> Result<Out, Error> {
            self.take().deserialize_u32(visitor).map_err(erase)
        }
        fn erased_deserialize_u64(&mut self, visitor: &mut dyn Visitor<'de>)
            -> Result<Out, Error> {
            self.take().deserialize_u64(visitor).map_err(erase)
        }
        fn erased_deserialize_i8(&mut self, visitor: &mut dyn Visitor<'de>)
            -> Result<Out, Error> {
            self.take().deserialize_i8(visitor).map_err(erase)
        }
        fn erased_deserialize_i16(&mut self, visitor: &mut dyn Visitor<'de>)
            -> Result<Out, Error> {
            self.take().deserialize_i16(visitor).map_err(erase)
        }
        fn erased_deserialize_i32(&mut self, visitor: &mut dyn Visitor<'de>)
            -> Result<Out, Error> {
            self.take().deserialize_i32(visitor).map_err(erase)
        }
        fn erased_deserialize_i64(&mut self, visitor: &mut dyn Visitor<'de>)
            -> Result<Out, Error> {
            self.take().deserialize_i64(visitor).map_err(erase)
        }
        fn erased_deserialize_i128(&mut self, visitor: &mut dyn Visitor<'de>)
            -> Result<Out, Error> {
            self.take().deserialize_i128(visitor).map_err(erase)
        }
        fn erased_deserialize_u128(&mut self, visitor: &mut dyn Visitor<'de>)
            -> Result<Out, Error> {
            self.take().deserialize_u128(visitor).map_err(erase)
        }
        fn erased_deserialize_f32(&mut self, visitor: &mut dyn Visitor<'de>)
            -> Result<Out, Error> {
            self.take().deserialize_f32(visitor).map_err(erase)
        }
        fn erased_deserialize_f64(&mut self, visitor: &mut dyn Visitor<'de>)
            -> Result<Out, Error> {
            self.take().deserialize_f64(visitor).map_err(erase)
        }
        fn erased_deserialize_char(&mut self, visitor: &mut dyn Visitor<'de>)
            -> Result<Out, Error> {
            self.take().deserialize_char(visitor).map_err(erase)
        }
        fn erased_deserialize_str(&mut self, visitor: &mut dyn Visitor<'de>)
            -> Result<Out, Error> {
            self.take().deserialize_str(visitor).map_err(erase)
        }
        fn erased_deserialize_string(&mut self,
            visitor: &mut dyn Visitor<'de>) -> Result<Out, Error> {
            self.take().deserialize_string(visitor).map_err(erase)
        }
        fn erased_deserialize_bytes(&mut self, visitor: &mut dyn Visitor<'de>)
            -> Result<Out, Error> {
            self.take().deserialize_bytes(visitor).map_err(erase)
        }
        fn erased_deserialize_byte_buf(&mut self,
            visitor: &mut dyn Visitor<'de>) -> Result<Out, Error> {
            self.take().deserialize_byte_buf(visitor).map_err(erase)
        }
        fn erased_deserialize_option(&mut self,
            visitor: &mut dyn Visitor<'de>) -> Result<Out, Error> {
            self.take().deserialize_option(visitor).map_err(erase)
        }
        fn erased_deserialize_unit(&mut self, visitor: &mut dyn Visitor<'de>)
            -> Result<Out, Error> {
        ...
        fn erased_deserialize_newtype_struct(&mut self, name: &'static str,
            visitor: &mut dyn Visitor<'de>) -> Result<Out, Error> {
            self.take().deserialize_newtype_struct(name,
                    visitor).map_err(erase)
        }
        fn erased_deserialize_seq(&mut self, visitor: &mut dyn Visitor<'de>)
            -> Result<Out, Error> {
        ...
        fn erased_deserialize_tuple_struct(&mut self, name: &'static str,
            len: usize, visitor: &mut dyn Visitor<'de>)
            -> Result<Out, Error> {
            self.take().deserialize_tuple_struct(name, len,
                    visitor).map_err(erase)
        }
        fn erased_deserialize_map(&mut self, visitor: &mut dyn Visitor<'de>)
            -> Result<Out, Error> {
            self.take().deserialize_map(visitor).map_err(erase)
        }
        fn erased_deserialize_struct(&mut self, name: &'static str,
            fields: &'static [&'static str], visitor: &mut dyn Visitor<'de>)
            -> Result<Out, Error> {
            self.take().deserialize_struct(name, fields,
                    visitor).map_err(erase)
        }
        fn erased_deserialize_identifier(&mut self,
            visitor: &mut dyn Visitor<'de>) -> Result<Out, Error> {
            self.take().deserialize_identifier(visitor).map_err(erase)
        }
        fn erased_deserialize_enum(&mut self, name: &'static str,
            variants: &'static [&'static str], visitor: &mut dyn Visitor<'de>)
            -> Result<Out, Error> {
            self.take().deserialize_enum(name, variants,
                    visitor).map_err(erase)
        }
        fn erased_deserialize_ignored_any(&mut self,
            visitor: &mut dyn Visitor<'de>) -> Result<Out, Error> {
    ...
    impl<'de, T> Visitor<'de> for erase::Visitor<T> where
        ...
        fn erased_visit_borrowed_bytes(&mut self, v: &'de [u8])
            -> Result<Out, Error> {
            unsafe {
                self.take().visit_borrowed_bytes(v).unsafe_map(Out::new)
            }
        }
        #[cfg(any(feature = "std", feature = "alloc"))]
        fn erased_visit_byte_buf(&mut self, v: Vec<u8>)
        ...
        fn erased_visit_some(&mut self,
            deserializer: &mut dyn Deserializer<'de>) -> Result<Out, Error> {
            unsafe {
                self.take().visit_some(deserializer).unsafe_map(Out::new)
            }
        }
        ...
        fn erased_visit_seq(&mut self, seq: &mut dyn SeqAccess<'de>)
            -> Result<Out, Error> {
            unsafe { self.take().visit_seq(seq).unsafe_map(Out::new) }
        }
        fn erased_visit_map(&mut self, map: &mut dyn MapAccess<'de>)
            -> Result<Out, Error> {
            unsafe { self.take().visit_map(map).unsafe_map(Out::new) }
        }
        fn erased_visit_enum(&mut self, data: &mut dyn EnumAccess<'de>)
            -> Result<Out, Error> {
            unsafe { self.take().visit_enum(data).unsafe_map(Out::new) }
        }
    }
    impl<'de, T> SeqAccess<'de> for erase::SeqAccess<T> where
        T: serde::de::SeqAccess<'de> {
        fn erased_next_element(&mut self, seed: &mut dyn DeserializeSeed<'de>)
            -> Result<Option<Out>, Error> {
    ...
    impl<'de, T> MapAccess<'de> for erase::MapAccess<T> where
        T: serde::de::MapAccess<'de> {
        fn erased_next_key(&mut self, seed: &mut dyn DeserializeSeed<'de>)
            -> Result<Option<Out>, Error> {
            self.as_mut().next_key_seed(seed).map_err(erase)
        }
        fn erased_next_value(&mut self, seed: &mut dyn DeserializeSeed<'de>)
            -> Result<Out, Error> {
            self.as_mut().next_value_seed(seed).map_err(erase)
        }
        fn erased_next_entry(&mut self, k: &mut dyn DeserializeSeed<'de>,
    ...
    impl<'de, T> EnumAccess<'de> for erase::EnumAccess<T> where
        T: serde::de::EnumAccess<'de> {
        fn erased_variant_seed(&mut self, seed: &mut dyn DeserializeSeed<'de>)
            -> Result<(Out, Variant<'de>), Error> {
                                ...
                                Variant {
                                    ...
                                    unit_variant: {
                                        unsafe fn unit_variant<'de, T>(a: Any) -> Result<(), Error>
                                            where T: serde::de::EnumAccess<'de> {
                                            unsafe {
                                    ...
                                    visit_newtype: {
                                        unsafe fn visit_newtype<'de,
                                            T>(a: Any, seed: &mut dyn DeserializeSeed<'de>)
                                            -> Result<Out, Error> where T: serde::de::EnumAccess<'de> {
                                            unsafe {
                                    ...
                                    tuple_variant: {
                                        unsafe fn tuple_variant<'de,
                                            T>(a: Any, len: usize, visitor: &mut dyn Visitor<'de>)
                                            -> Result<Out, Error> where T: serde::de::EnumAccess<'de> {
                                            unsafe {
                                                a.take::<T::Variant>().tuple_variant(len,
                                                        visitor).map_err(erase)
                                            }
                                        }
                                        tuple_variant::<T>
                                    ...
                                    struct_variant: {
                                        unsafe fn struct_variant<'de,
                                            T>(a: Any, fields: &'static [&'static str],
                                            visitor: &mut dyn Visitor<'de>) -> Result<Out, Error> where
                                            T: serde::de::EnumAccess<'de> {
                                            unsafe {
                                                a.take::<T::Variant>().struct_variant(fields,
                                                        visitor).map_err(erase)
                                            }
                                        }
                                        struct_variant::<T>
    ...
    impl<'de, 'a> serde::Deserializer<'de> for &'a mut dyn Deserializer<'de> {
        ...
        fn deserialize_any<V>(self, visitor: V) -> Result<V::Value, Error>
            ...
            unsafe {
                self.erased_deserialize_any(&mut erased).unsafe_map(Out::take)
            }
        }
        fn deserialize_bool<V>(self, visitor: V) -> Result<V::Value, Error>
            ...
            let mut erased = erase::Visitor { state: Some(visitor) };
            unsafe {
                self.erased_deserialize_bool(&mut erased).unsafe_map(Out::take)
            }
        }
        fn deserialize_u8<V>(self, visitor: V) -> Result<V::Value, Error>
            ...
            let mut erased = erase::Visitor { state: Some(visitor) };
            unsafe {
                self.erased_deserialize_u8(&mut erased).unsafe_map(Out::take)
            }
        }
        fn deserialize_u16<V>(self, visitor: V) -> Result<V::Value, Error>
            ...
            let mut erased = erase::Visitor { state: Some(visitor) };
            unsafe {
                self.erased_deserialize_u16(&mut erased).unsafe_map(Out::take)
            }
        }
        fn deserialize_u32<V>(self, visitor: V) -> Result<V::Value, Error>
            ...
            let mut erased = erase::Visitor { state: Some(visitor) };
            unsafe {
                self.erased_deserialize_u32(&mut erased).unsafe_map(Out::take)
            }
        }
        fn deserialize_u64<V>(self, visitor: V) -> Result<V::Value, Error>
            ...
            let mut erased = erase::Visitor { state: Some(visitor) };
            unsafe {
                self.erased_deserialize_u64(&mut erased).unsafe_map(Out::take)
            }
        }
        fn deserialize_i8<V>(self, visitor: V) -> Result<V::Value, Error>
            ...
            let mut erased = erase::Visitor { state: Some(visitor) };
            unsafe {
                self.erased_deserialize_i8(&mut erased).unsafe_map(Out::take)
            }
        }
        fn deserialize_i16<V>(self, visitor: V) -> Result<V::Value, Error>
            ...
            let mut erased = erase::Visitor { state: Some(visitor) };
            unsafe {
                self.erased_deserialize_i16(&mut erased).unsafe_map(Out::take)
            }
        }
        fn deserialize_i32<V>(self, visitor: V) -> Result<V::Value, Error>
            ...
            let mut erased = erase::Visitor { state: Some(visitor) };
            unsafe {
                self.erased_deserialize_i32(&mut erased).unsafe_map(Out::take)
            }
        }
        fn deserialize_i64<V>(self, visitor: V) -> Result<V::Value, Error>
            ...
            let mut erased = erase::Visitor { state: Some(visitor) };
            unsafe {
                self.erased_deserialize_i64(&mut erased).unsafe_map(Out::take)
            }
        }
        fn deserialize_i128<V>(self, visitor: V) -> Result<V::Value, Error>
            ...
            let mut erased = erase::Visitor { state: Some(visitor) };
            unsafe {
                self.erased_deserialize_i128(&mut erased).unsafe_map(Out::take)
            }
        }
        fn deserialize_u128<V>(self, visitor: V) -> Result<V::Value, Error>
            ...
            let mut erased = erase::Visitor { state: Some(visitor) };
            unsafe {
                self.erased_deserialize_u128(&mut erased).unsafe_map(Out::take)
            }
        }
        fn deserialize_f32<V>(self, visitor: V) -> Result<V::Value, Error>
            ...
            let mut erased = erase::Visitor { state: Some(visitor) };
            unsafe {
                self.erased_deserialize_f32(&mut erased).unsafe_map(Out::take)
            }
        }
        fn deserialize_f64<V>(self, visitor: V) -> Result<V::Value, Error>
            ...
            let mut erased = erase::Visitor { state: Some(visitor) };
            unsafe {
                self.erased_deserialize_f64(&mut erased).unsafe_map(Out::take)
            }
        }
        fn deserialize_char<V>(self, visitor: V) -> Result<V::Value, Error>
            ...
            let mut erased = erase::Visitor { state: Some(visitor) };
            unsafe {
                self.erased_deserialize_char(&mut erased).unsafe_map(Out::take)
            }
        }
        fn deserialize_str<V>(self, visitor: V) -> Result<V::Value, Error>
            ...
            let mut erased = erase::Visitor { state: Some(visitor) };
            unsafe {
                self.erased_deserialize_str(&mut erased).unsafe_map(Out::take)
            }
        }
        fn deserialize_string<V>(self, visitor: V) -> Result<V::Value, Error>
            ...
            let mut erased = erase::Visitor { state: Some(visitor) };
            unsafe {
                self.erased_deserialize_string(&mut erased).unsafe_map(Out::take)
            }
        }
        fn deserialize_bytes<V>(self, visitor: V) -> Result<V::Value, Error>
            ...
            let mut erased = erase::Visitor { state: Some(visitor) };
            unsafe {
                self.erased_deserialize_bytes(&mut erased).unsafe_map(Out::take)
            }
        }
        fn deserialize_byte_buf<V>(self, visitor: V)
            -> Result<V::Value, Error> where V: serde::de::Visitor<'de> {
            let mut erased = erase::Visitor { state: Some(visitor) };
            unsafe {
        ...
        fn deserialize_option<V>(self, visitor: V) -> Result<V::Value, Error>
            ...
            let mut erased = erase::Visitor { state: Some(visitor) };
            unsafe {
                self.erased_deserialize_option(&mut erased).unsafe_map(Out::take)
            }
        }
        fn deserialize_unit<V>(self, visitor: V) -> Result<V::Value, Error>
            ...
            let mut erased = erase::Visitor { state: Some(visitor) };
            unsafe {
                self.erased_deserialize_unit(&mut erased).unsafe_map(Out::take)
            }
        }
        fn deserialize_unit_struct<V>(self, name: &'static str, visitor: V)
            ...
            let mut erased = erase::Visitor { state: Some(visitor) };
            unsafe {
                self.erased_deserialize_unit_struct(name,
                        &mut erased).unsafe_map(Out::take)
            }
        }
        fn deserialize_newtype_struct<V>(self, name: &'static str, visitor: V)
            ...
            let mut erased = erase::Visitor { state: Some(visitor) };
            unsafe {
                self.erased_deserialize_newtype_struct(name,
                        &mut erased).unsafe_map(Out::take)
            }
        }
        fn deserialize_seq<V>(self, visitor: V) -> Result<V::Value, Error>
            ...
            let mut erased = erase::Visitor { state: Some(visitor) };
            unsafe {
                self.erased_deserialize_seq(&mut erased).unsafe_map(Out::take)
            }
        }
        fn deserialize_tuple<V>(self, len: usize, visitor: V)
            ...
            let mut erased = erase::Visitor { state: Some(visitor) };
            unsafe {
                self.erased_deserialize_tuple(len,
                        &mut erased).unsafe_map(Out::take)
            }
        }
        fn deserialize_tuple_struct<V>(self, name: &'static str, len: usize,
            visitor: V) -> Result<V::Value, Error> where
            V: serde::de::Visitor<'de> {
            let mut erased = erase::Visitor { state: Some(visitor) };
            unsafe {
                self.erased_deserialize_tuple_struct(name, len,
                        &mut erased).unsafe_map(Out::take)
            }
        }
        fn deserialize_map<V>(self, visitor: V) -> Result<V::Value, Error>
            ...
            let mut erased = erase::Visitor { state: Some(visitor) };
            unsafe {
                self.erased_deserialize_map(&mut erased).unsafe_map(Out::take)
            }
        }
        fn deserialize_struct<V>(self, name: &'static str,
            ...
            let mut erased = erase::Visitor { state: Some(visitor) };
            unsafe {
                self.erased_deserialize_struct(name, fields,
                        &mut erased).unsafe_map(Out::take)
            }
        }
        ...
        fn deserialize_enum<V>(self, name: &'static str,
            ...
            let mut erased = erase::Visitor { state: Some(visitor) };
            unsafe {
                self.erased_deserialize_enum(name, variants,
                        &mut erased).unsafe_map(Out::take)
            }
        }
    ...
    impl<'de, 'a> serde::Deserializer<'de> for
        &'a mut (dyn Deserializer<'de> + Send) {
        type Error = Error;
        fn deserialize_any<V>(self, visitor: V) -> Result<V::Value, Error>
            where V: serde::de::Visitor<'de> {
            let mut erased = erase::Visitor { state: Some(visitor) };
    ...
    impl<'de, 'a> serde::Deserializer<'de> for
        &'a mut (dyn Deserializer<'de> + Sync) {
        type Error = Error;
        fn deserialize_any<V>(self, visitor: V) -> Result<V::Value, Error>
            where V: serde::de::Visitor<'de> {
            let mut erased = erase::Visitor { state: Some(visitor) };
    ...
    impl<'de> serde::Deserializer<'de> for Box<dyn Deserializer<'de>> {
        ...
        fn deserialize_bool<V>(mut self, visitor: V)
            -> Result<V::Value, Error> where V: serde::de::Visitor<'de> {
            let mut erased = erase::Visitor { state: Some(visitor) };
            unsafe {
                self.erased_deserialize_bool(&mut erased).unsafe_map(Out::take)
        ...
        fn deserialize_i128<V>(mut self, visitor: V)
            -> Result<V::Value, Error> where V: serde::de::Visitor<'de> {
            let mut erased = erase::Visitor { state: Some(visitor) };
            unsafe {
                self.erased_deserialize_i128(&mut erased).unsafe_map(Out::take)
        ...
        fn deserialize_u128<V>(mut self, visitor: V)
            -> Result<V::Value, Error> where V: serde::de::Visitor<'de> {
            let mut erased = erase::Visitor { state: Some(visitor) };
            unsafe {
                self.erased_deserialize_u128(&mut erased).unsafe_map(Out::take)
        ...
        fn deserialize_char<V>(mut self, visitor: V)
            -> Result<V::Value, Error> where V: serde::de::Visitor<'de> {
            let mut erased = erase::Visitor { state: Some(visitor) };
            unsafe {
                self.erased_deserialize_char(&mut erased).unsafe_map(Out::take)
        ...
        fn deserialize_byte_buf<V>(mut self, visitor: V)
            -> Result<V::Value, Error> where V: serde::de::Visitor<'de> {
            let mut erased = erase::Visitor { state: Some(visitor) };
            unsafe {
                self.erased_deserialize_byte_buf(&mut erased).unsafe_map(Out::take)
        ...
        fn deserialize_option<V>(mut self, visitor: V)
            -> Result<V::Value, Error> where V: serde::de::Visitor<'de> {
            let mut erased = erase::Visitor { state: Some(visitor) };
            unsafe {
                self.erased_deserialize_option(&mut erased).unsafe_map(Out::take)
        ...
        fn deserialize_unit<V>(mut self, visitor: V)
            -> Result<V::Value, Error> where V: serde::de::Visitor<'de> {
            let mut erased = erase::Visitor { state: Some(visitor) };
            unsafe {
                self.erased_deserialize_unit(&mut erased).unsafe_map(Out::take)
        ...
        fn deserialize_unit_struct<V>(mut self, name: &'static str,
            visitor: V) -> Result<V::Value, Error> where
            V: serde::de::Visitor<'de> {
            let mut erased = erase::Visitor { state: Some(visitor) };
            unsafe {
        ...
        fn deserialize_newtype_struct<V>(mut self, name: &'static str,
            visitor: V) -> Result<V::Value, Error> where
            V: serde::de::Visitor<'de> {
            let mut erased = erase::Visitor { state: Some(visitor) };
            unsafe {
        ...
        fn deserialize_tuple_struct<V>(mut self, name: &'static str,
            len: usize, visitor: V) -> Result<V::Value, Error> where
            V: serde::de::Visitor<'de> {
            let mut erased = erase::Visitor { state: Some(visitor) };
            unsafe {
                self.erased_deserialize_tuple_struct(name, len,
        ...
        fn deserialize_identifier<V>(mut self, visitor: V)
            -> Result<V::Value, Error> where V: serde::de::Visitor<'de> {
            let mut erased = erase::Visitor { state: Some(visitor) };
            unsafe {
                self.erased_deserialize_identifier(&mut erased).unsafe_map(Out::take)
        ...
        fn deserialize_enum<V>(mut self, name: &'static str,
            variants: &'static [&'static str], visitor: V)
            -> Result<V::Value, Error> where V: serde::de::Visitor<'de> {
            let mut erased = erase::Visitor { state: Some(visitor) };
            unsafe {
    ...
    impl<'de, 'a> serde::de::Visitor<'de> for &'a mut dyn Visitor<'de> {
        ...
        fn visit_bool<E>(self, v: bool) -> Result<Out, E> where
            E: serde::de::Error {
            self.erased_visit_bool(v).map_err(unerase)
        }
        fn visit_i8<E>(self, v: i8) -> Result<Out, E> where
            E: serde::de::Error {
            self.erased_visit_i8(v).map_err(unerase)
        }
        fn visit_i16<E>(self, v: i16) -> Result<Out, E> where
            E: serde::de::Error {
            self.erased_visit_i16(v).map_err(unerase)
        }
        fn visit_i32<E>(self, v: i32) -> Result<Out, E> where
            E: serde::de::Error {
            self.erased_visit_i32(v).map_err(unerase)
        }
        fn visit_i64<E>(self, v: i64) -> Result<Out, E> where
            E: serde::de::Error {
            self.erased_visit_i64(v).map_err(unerase)
        }
        fn visit_u8<E>(self, v: u8) -> Result<Out, E> where
            E: serde::de::Error {
            self.erased_visit_u8(v).map_err(unerase)
        }
        fn visit_u16<E>(self, v: u16) -> Result<Out, E> where
            E: serde::de::Error {
            self.erased_visit_u16(v).map_err(unerase)
        }
        fn visit_u32<E>(self, v: u32) -> Result<Out, E> where
            E: serde::de::Error {
            self.erased_visit_u32(v).map_err(unerase)
        }
        fn visit_u64<E>(self, v: u64) -> Result<Out, E> where
            E: serde::de::Error {
            self.erased_visit_u64(v).map_err(unerase)
        }
        fn visit_i128<E>(self, v: i128) -> Result<Out, E> where
            E: serde::de::Error {
            self.erased_visit_i128(v).map_err(unerase)
        }
        fn visit_u128<E>(self, v: u128) -> Result<Out, E> where
            E: serde::de::Error {
            self.erased_visit_u128(v).map_err(unerase)
        }
        fn visit_f32<E>(self, v: f32) -> Result<Out, E> where
            E: serde::de::Error {
            self.erased_visit_f32(v).map_err(unerase)
        }
        fn visit_f64<E>(self, v: f64) -> Result<Out, E> where
            E: serde::de::Error {
            self.erased_visit_f64(v).map_err(unerase)
        }
        fn visit_char<E>(self, v: char) -> Result<Out, E> where
            E: serde::de::Error {
            self.erased_visit_char(v).map_err(unerase)
        }
        fn visit_str<E>(self, v: &str) -> Result<Out, E> where
            E: serde::de::Error {
            self.erased_visit_str(v).map_err(unerase)
        }
        fn visit_borrowed_str<E>(self, v: &'de str) -> Result<Out, E> where
            E: serde::de::Error {
            self.erased_visit_borrowed_str(v).map_err(unerase)
        }
        #[cfg(any(feature = "std", feature = "alloc"))]
        fn visit_string<E>(self, v: String) -> Result<Out, E> where
            E: serde::de::Error {
            self.erased_visit_string(v).map_err(unerase)
        }
        fn visit_bytes<E>(self, v: &[u8]) -> Result<Out, E> where
            E: serde::de::Error {
            self.erased_visit_bytes(v).map_err(unerase)
        }
        fn visit_borrowed_bytes<E>(self, v: &'de [u8]) -> Result<Out, E> where
            E: serde::de::Error {
            self.erased_visit_borrowed_bytes(v).map_err(unerase)
        }
        #[cfg(any(feature = "std", feature = "alloc"))]
        fn visit_byte_buf<E>(self, v: Vec<u8>) -> Result<Out, E> where
            E: serde::de::Error {
        ...
        fn visit_some<D>(self, deserializer: D) -> Result<Out, D::Error> where
            D: serde::Deserializer<'de> {
            let mut erased =
                erase::Deserializer { state: Some(deserializer) };
    ...
    impl<'de, 'a> serde::de::SeqAccess<'de> for &'a mut dyn SeqAccess<'de> {
        ...
        fn next_element_seed<T>(&mut self, seed: T)
            -> Result<Option<T::Value>, Error> where
            T: serde::de::DeserializeSeed<'de> {
            let mut seed = erase::DeserializeSeed { state: Some(seed) };
            unsafe {
                (**self).erased_next_element(&mut seed).map(|opt|
                        opt.unsafe_map(Out::take))
            }
        }
        fn size_hint(&self) -> Option<usize> { (**self).erased_size_hint() }
    }
    impl<'de, 'a> serde::de::MapAccess<'de> for &'a mut dyn MapAccess<'de> {
        type Error = Error;
        fn next_key_seed<K>(&mut self, seed: K)
            -> Result<Option<K::Value>, Error> where
            K: serde::de::DeserializeSeed<'de> {
            let mut erased = erase::DeserializeSeed { state: Some(seed) };
            unsafe {
                (**self).erased_next_key(&mut erased).map(|opt|
                        opt.unsafe_map(Out::take))
            }
        }
        fn next_value_seed<V>(&mut self, seed: V) -> Result<V::Value, Error>
            ...
            let mut erased = erase::DeserializeSeed { state: Some(seed) };
            unsafe {
                (**self).erased_next_value(&mut erased).unsafe_map(Out::take)
            }
        }
        fn size_hint(&self) -> Option<usize> { (**self).erased_size_hint() }
    }
    ...
    pub struct Variant<'de> {
        ...
        visit_newtype: unsafe fn(Any, seed: &mut dyn DeserializeSeed<'de>)
            -> Result<Out, Error>,
        tuple_variant: unsafe fn(Any, len: usize,
            visitor: &mut dyn Visitor<'de>) -> Result<Out, Error>,
        struct_variant: unsafe fn(Any, fields: &'static [&'static str],
            visitor: &mut dyn Visitor<'de>) -> Result<Out, Error>,
    }
    impl<'de> serde::de::VariantAccess<'de> for Variant<'de> {
        ...
        fn tuple_variant<V>(self, len: usize, visitor: V)
            ...
            let mut erased = erase::Visitor { state: Some(visitor) };
            unsafe {
                (self.tuple_variant)(self.data, len,
                        &mut erased).unsafe_map(Out::take)
            }
        }
        fn struct_variant<V>(self, fields: &'static [&'static str],
            ...
            let mut erased = erase::Visitor { state: Some(visitor) };
            unsafe {
                (self.struct_variant)(self.data, fields,
                        &mut erased).unsafe_map(Out::take)
            }
        }
    }
    ...
    impl<'de, 'a> Deserializer<'de> for
        Box<dyn Deserializer<'de> + Send + Sync + 'a> {
        fn erased_deserialize_any(&mut self, visitor: &mut dyn Visitor<'de>)
            -> Result<Out, Error> {
            (**self).erased_deserialize_any(visitor)
        }
    ...
    impl<'de, 'a, T: ?Sized + Deserializer<'de>> Deserializer<'de> for
        &'a mut T {
        fn erased_deserialize_any(&mut self, visitor: &mut dyn Visitor<'de>)
            -> Result<Out, Error> {
            (**self).erased_deserialize_any(visitor)
    ...
    fn erase<E>(e: E) -> Error where E: Display {
        serde::de::Error::custom(e)
    }
    fn unerase<E>(e: Error) -> E where E: serde::de::Error { E::custom(e) }
}
mod error {
        ...
        fn fmt(&self, f: &mut ::core::fmt::Formatter) -> ::core::fmt::Result {
            match *self {
                Self { msg: ref __self_0_0 } => {
                    let debug_trait_builder =
                        &mut ::core::fmt::Formatter::debug_struct(f, "Error");
                    let _ =
                        ::core::fmt::DebugStruct::field(debug_trait_builder, "msg",
                            &&(*__self_0_0));
                    ::core::fmt::DebugStruct::finish(debug_trait_builder)
                }
            }
...
mod map {
    pub(crate) trait ResultExt<T, E> {
        unsafe fn unsafe_map<U>(self, op: unsafe fn(T) -> U)
        -> Result<U, E>;
    }
    impl<T, E> ResultExt<T, E> for Result<T, E> {
        unsafe fn unsafe_map<U>(self, op: unsafe fn(T) -> U) -> Result<U, E> {
            match self { Ok(t) => Ok(unsafe { op(t) }), Err(e) => Err(e), }
        }
    }
...
mod ser {
    ...
    /// ```
    pub trait Serialize {
        fn erased_serialize(&self, v: &mut dyn Serializer)
        -> Result<Ok, Error>;
    }
    ...
    pub trait Serializer {
        ...
        -> Result<Ok, Error>;
        fn erased_serialize_some(&mut self, v: &dyn Serialize)
        -> Result<Ok, Error>;
        fn erased_serialize_unit(&mut self)
        -> Result<Ok, Error>;
        fn erased_serialize_unit_struct(&mut self, name: &'static str)
        -> Result<Ok, Error>;
        fn erased_serialize_unit_variant(&mut self, name: &'static str,
        variant_index: u32, variant: &'static str)
        -> Result<Ok, Error>;
        fn erased_serialize_newtype_struct(&mut self, name: &'static str,
        v: &dyn Serialize)
        -> Result<Ok, Error>;
        fn erased_serialize_newtype_variant(&mut self, name: &'static str,
        variant_index: u32, variant: &'static str, v: &dyn Serialize)
        -> Result<Ok, Error>;
        fn erased_serialize_seq(&mut self, len: Option<usize>)
        -> Result<Seq, Error>;
        fn erased_serialize_tuple(&mut self, len: usize)
        -> Result<Tuple, Error>;
        fn erased_serialize_tuple_struct(&mut self, name: &'static str,
        len: usize)
        -> Result<TupleStruct, Error>;
        fn erased_serialize_tuple_variant(&mut self, name: &'static str,
        variant_index: u32, variant: &'static str, len: usize)
        -> Result<TupleVariant, Error>;
        fn erased_serialize_map(&mut self, len: Option<usize>)
        -> Result<Map, Error>;
        fn erased_serialize_struct(&mut self, name: &'static str, len: usize)
        -> Result<Struct, Error>;
        fn erased_serialize_struct_variant(&mut self, name: &'static str,
        variant_index: u32, variant: &'static str, len: usize)
    ...
    impl dyn Serializer {
        ...
        /// }
        /// ```
        pub fn erase<S>(serializer: S) -> erase::Serializer<S> where
            S: serde::Serializer, S::Ok: 'static {
            erase::Serializer { state: Some(serializer) }
        }
    }
    pub struct Ok {
        data: Any,
    ...
    impl Ok {
        unsafe fn new<T>(t: T) -> Self { Ok { data: unsafe { Any::new(t) } } }
        unsafe fn take<T>(self) -> T { unsafe { self.data.take() } }
    }
    impl<T> Serialize for T where T: ?Sized + serde::Serialize {
    ...
    mod erase {
        ...
        impl<S> Serializer<S> {
            pub(crate) fn take(&mut self) -> S { self.state.take().unwrap() }
            pub(crate) fn as_ref(&self) -> &S { self.state.as_ref().unwrap() }
        }
    }
    impl<T> Serializer for erase::Serializer<T> where T: serde::Serializer {
        fn erased_serialize_bool(&mut self, v: bool) -> Result<Ok, Error> {
            unsafe {
                self.take().serialize_bool(v).unsafe_map(Ok::new).map_err(erase)
            }
        }
        fn erased_serialize_i8(&mut self, v: i8) -> Result<Ok, Error> {
            unsafe {
                self.take().serialize_i8(v).unsafe_map(Ok::new).map_err(erase)
            }
        }
        fn erased_serialize_i16(&mut self, v: i16) -> Result<Ok, Error> {
            unsafe {
                self.take().serialize_i16(v).unsafe_map(Ok::new).map_err(erase)
            }
        }
        fn erased_serialize_i32(&mut self, v: i32) -> Result<Ok, Error> {
            unsafe {
                self.take().serialize_i32(v).unsafe_map(Ok::new).map_err(erase)
            }
        }
        fn erased_serialize_i64(&mut self, v: i64) -> Result<Ok, Error> {
            unsafe {
                self.take().serialize_i64(v).unsafe_map(Ok::new).map_err(erase)
            }
        }
        fn erased_serialize_u8(&mut self, v: u8) -> Result<Ok, Error> {
            unsafe {
                self.take().serialize_u8(v).unsafe_map(Ok::new).map_err(erase)
            }
        }
        fn erased_serialize_u16(&mut self, v: u16) -> Result<Ok, Error> {
            unsafe {
                self.take().serialize_u16(v).unsafe_map(Ok::new).map_err(erase)
            }
        }
        fn erased_serialize_u32(&mut self, v: u32) -> Result<Ok, Error> {
            unsafe {
                self.take().serialize_u32(v).unsafe_map(Ok::new).map_err(erase)
            }
        }
        fn erased_serialize_u64(&mut self, v: u64) -> Result<Ok, Error> {
            unsafe {
                self.take().serialize_u64(v).unsafe_map(Ok::new).map_err(erase)
            }
        }
        fn erased_serialize_i128(&mut self, v: i128) -> Result<Ok, Error> {
            unsafe {
                self.take().serialize_i128(v).unsafe_map(Ok::new).map_err(erase)
            }
        }
        fn erased_serialize_u128(&mut self, v: u128) -> Result<Ok, Error> {
            unsafe {
                self.take().serialize_u128(v).unsafe_map(Ok::new).map_err(erase)
            }
        }
        fn erased_serialize_f32(&mut self, v: f32) -> Result<Ok, Error> {
            unsafe {
                self.take().serialize_f32(v).unsafe_map(Ok::new).map_err(erase)
            }
        }
        fn erased_serialize_f64(&mut self, v: f64) -> Result<Ok, Error> {
            unsafe {
                self.take().serialize_f64(v).unsafe_map(Ok::new).map_err(erase)
            }
        }
        fn erased_serialize_char(&mut self, v: char) -> Result<Ok, Error> {
            unsafe {
                self.take().serialize_char(v).unsafe_map(Ok::new).map_err(erase)
            }
        }
        fn erased_serialize_str(&mut self, v: &str) -> Result<Ok, Error> {
            unsafe {
                self.take().serialize_str(v).unsafe_map(Ok::new).map_err(erase)
            }
        }
        fn erased_serialize_bytes(&mut self, v: &[u8]) -> Result<Ok, Error> {
            unsafe {
                self.take().serialize_bytes(v).unsafe_map(Ok::new).map_err(erase)
            }
        }
        fn erased_serialize_none(&mut self) -> Result<Ok, Error> {
            unsafe {
                self.take().serialize_none().unsafe_map(Ok::new).map_err(erase)
            }
        }
        fn erased_serialize_some(&mut self, v: &dyn Serialize)
            -> Result<Ok, Error> {
            unsafe {
                self.take().serialize_some(v).unsafe_map(Ok::new).map_err(erase)
            }
        }
        fn erased_serialize_unit(&mut self) -> Result<Ok, Error> {
            unsafe {
                self.take().serialize_unit().unsafe_map(Ok::new).map_err(erase)
            }
        }
        fn erased_serialize_unit_struct(&mut self, name: &'static str)
            -> Result<Ok, Error> {
            unsafe {
                self.take().serialize_unit_struct(name).unsafe_map(Ok::new).map_err(erase)
            }
        }
        fn erased_serialize_unit_variant(&mut self, name: &'static str,
            variant_index: u32, variant: &'static str) -> Result<Ok, Error> {
            unsafe {
                self.take().serialize_unit_variant(name, variant_index,
                            variant).unsafe_map(Ok::new).map_err(erase)
            }
        }
        fn erased_serialize_newtype_struct(&mut self, name: &'static str,
            v: &dyn Serialize) -> Result<Ok, Error> {
            unsafe {
                self.take().serialize_newtype_struct(name,
                            v).unsafe_map(Ok::new).map_err(erase)
            }
        }
        fn erased_serialize_newtype_variant(&mut self, name: &'static str,
            variant_index: u32, variant: &'static str, v: &dyn Serialize)
            -> Result<Ok, Error> {
            unsafe {
                self.take().serialize_newtype_variant(name, variant_index,
                            variant, v).unsafe_map(Ok::new).map_err(erase)
            }
        }
        fn erased_serialize_seq(&mut self, len: Option<usize>)
            -> Result<Seq, Error> {
            unsafe {
                self.take().serialize_seq(len).unsafe_map(Seq::new).map_err(erase)
            }
        }
        fn erased_serialize_tuple(&mut self, len: usize)
            -> Result<Tuple, Error> {
        ...
        fn erased_serialize_tuple_struct(&mut self, name: &'static str,
            len: usize) -> Result<TupleStruct, Error> {
            unsafe {
                self.take().serialize_tuple_struct(name,
                            len).unsafe_map(TupleStruct::new).map_err(erase)
            }
        }
        fn erased_serialize_tuple_variant(&mut self, name: &'static str,
            variant_index: u32, variant: &'static str, len: usize)
            -> Result<TupleVariant, Error> {
            unsafe {
                self.take().serialize_tuple_variant(name, variant_index,
                            variant, len).unsafe_map(TupleVariant::new).map_err(erase)
            }
        }
        fn erased_serialize_map(&mut self, len: Option<usize>)
            -> Result<Map, Error> {
            unsafe {
                self.take().serialize_map(len).unsafe_map(Map::new).map_err(erase)
            }
        }
        fn erased_serialize_struct(&mut self, name: &'static str, len: usize)
            -> Result<Struct, Error> {
            unsafe {
                self.take().serialize_struct(name,
                            len).unsafe_map(Struct::new).map_err(erase)
            }
        }
        fn erased_serialize_struct_variant(&mut self, name: &'static str,
            variant_index: u32, variant: &'static str, len: usize)
            -> Result<StructVariant, Error> {
            unsafe {
                self.take().serialize_struct_variant(name, variant_index,
                            variant, len).unsafe_map(StructVariant::new).map_err(erase)
            }
        }
        fn erased_is_human_readable(&self) -> bool {
            self.as_ref().is_human_readable()
    ...
    /// ```
    pub fn serialize<T, S>(value: &T, serializer: S)
        -> Result<S::Ok, S::Error> where T: ?Sized + Serialize,
        S: serde::Serializer {
    ...
    impl<'erased> crate::private::serde::Serialize for dyn Serialize + 'erased
        ...
        fn serialize<S>(&self, serializer: S)
            -> crate::private::Result<S::Ok, S::Error> where
            S: crate::private::serde::Serializer {
            fn __check_erased_serialize_supertrait<__T>() where
    ...
    impl<'erased> crate::private::serde::Serialize for
        dyn Serialize + crate::private::Send + 'erased where  {
        fn serialize<S>(&self, serializer: S)
            -> crate::private::Result<S::Ok, S::Error> where
            S: crate::private::serde::Serializer {
            crate::serialize(self, serializer)
    ...
    impl<'erased> crate::private::serde::Serialize for
        dyn Serialize + crate::private::Sync + 'erased where  {
        fn serialize<S>(&self, serializer: S)
            -> crate::private::Result<S::Ok, S::Error> where
            S: crate::private::serde::Serializer {
            crate::serialize(self, serializer)
    ...
    impl<'erased> crate::private::serde::Serialize for
        dyn Serialize + crate::private::Send + crate::private::Sync + 'erased
        where  {
        fn serialize<S>(&self, serializer: S)
            -> crate::private::Result<S::Ok, S::Error> where
            S: crate::private::serde::Serializer {
    ...
    impl<'a> serde::Serializer for &'a mut dyn Serializer {
        ...
        fn serialize_newtype_struct<T>(self, name: &'static str, v: &T)
            -> Result<Ok, Error> where T: ?Sized + serde::Serialize {
            self.erased_serialize_newtype_struct(name, &v)
        }
        fn serialize_newtype_variant<T>(self, name: &'static str,
            variant_index: u32, variant: &'static str, v: &T)
            -> Result<Ok, Error> where T: ?Sized + serde::Serialize {
            self.erased_serialize_newtype_variant(name, variant_index,
                variant, &v)
        }
        ...
        fn serialize_tuple_variant(self, name: &'static str,
            ...
            self.erased_serialize_tuple_variant(name, variant_index, variant,
                len)
        }
        ...
        fn serialize_struct_variant(self, name: &'static str,
            ...
            self.erased_serialize_struct_variant(name, variant_index, variant,
                len)
        }
        fn is_human_readable(&self) -> bool {
            self.erased_is_human_readable()
    ...
    pub struct Seq<'a> {
        data: Any,
        serialize_element: unsafe fn(&mut Any, &dyn Serialize)
            -> Result<(), Error>,
        end: unsafe fn(Any) -> Result<Ok, Error>,
        lifetime: PhantomData<&'a dyn Serializer>,
    }
    impl<'a> Seq<'a> {
        unsafe fn new<T>(data: T) -> Self where T: serde::ser::SerializeSeq {
            Seq {
                data: unsafe { Any::new(data) },
                serialize_element: {
                    unsafe fn serialize_element<T>(data: &mut Any,
                        v: &dyn Serialize) -> Result<(), Error> where
                    ...
                    unsafe fn end<T>(data: Any) -> Result<Ok, Error> where
                        T: serde::ser::SerializeSeq {
                        unsafe {
    ...
    impl<'a> SerializeSeq for Seq<'a> {
        ...
        fn end(self) -> Result<Ok, Error> { unsafe { (self.end)(self.data) } }
    }
    pub struct Tuple<'a> {
        data: Any,
        serialize_element: unsafe fn(&mut Any, &dyn Serialize)
    ...
    impl<'a> Tuple<'a> {
        unsafe fn new<T>(data: T) -> Self where
    ...
    pub struct TupleStruct<'a> {
        data: Any,
        serialize_field: unsafe fn(&mut Any, &dyn Serialize)
            -> Result<(), Error>,
        end: unsafe fn(Any) -> Result<Ok, Error>,
        lifetime: PhantomData<&'a dyn Serializer>,
    }
    impl<'a> TupleStruct<'a> {
        unsafe fn new<T>(data: T) -> Self where
            ...
            TupleStruct {
                data: unsafe { Any::new(data) },
                serialize_field: {
                    unsafe fn serialize_field<T>(data: &mut Any,
                        v: &dyn Serialize) -> Result<(), Error> where
                        T: serde::ser::SerializeTupleStruct {
                        unsafe {
    ...
    impl<'a> SerializeTupleStruct for TupleStruct<'a> {
        type Ok = Ok;
        type Error = Error;
        fn serialize_field<T>(&mut self, value: &T) -> Result<(), Error> where
            T: ?Sized + serde::Serialize {
    ...
    pub struct Map<'a> {
        data: Any,
        serialize_key: unsafe fn(&mut Any, &dyn Serialize)
            -> Result<(), Error>,
        serialize_value: unsafe fn(&mut Any, &dyn Serialize)
            -> Result<(), Error>,
        serialize_entry: unsafe fn(&mut Any, &dyn Serialize, &dyn Serialize)
            -> Result<(), Error>,
        end: unsafe fn(Any) -> Result<Ok, Error>,
        lifetime: PhantomData<&'a dyn Serializer>,
    }
    impl<'a> Map<'a> {
        unsafe fn new<T>(data: T) -> Self where T: serde::ser::SerializeMap {
            Map {
                data: unsafe { Any::new(data) },
                serialize_key: {
                    unsafe fn serialize_key<T>(data: &mut Any,
                        v: &dyn Serialize) -> Result<(), Error> where
                ...
                serialize_value: {
                    unsafe fn serialize_value<T>(data: &mut Any,
                        v: &dyn Serialize) -> Result<(), Error> where
                        T: serde::ser::SerializeMap {
                        unsafe {
                ...
                serialize_entry: {
                    unsafe fn serialize_entry<T>(data: &mut Any,
                        k: &dyn Serialize, v: &dyn Serialize) -> Result<(), Error>
                        where T: serde::ser::SerializeMap {
                        unsafe {
    ...
    impl<'a> SerializeMap for Map<'a> {
        ...
        fn serialize_value<T>(&mut self, value: &T) -> Result<(), Error> where
            T: ?Sized + serde::Serialize {
            unsafe { (self.serialize_value)(&mut self.data, &value) }
        }
        fn serialize_entry<K, V>(&mut self, key: &K, value: &V)
            -> Result<(), Error> where K: ?Sized + serde::Serialize,
    ...
    pub struct Struct<'a> {
        data: Any,
        serialize_field: unsafe fn(&mut Any, &'static str, &dyn Serialize)
            -> Result<(), Error>,
        end: unsafe fn(Any) -> Result<Ok, Error>,
        lifetime: PhantomData<&'a dyn Serializer>,
    }
    impl<'a> Struct<'a> {
        unsafe fn new<T>(data: T) -> Self where
            ...
            Struct {
                ...
                serialize_field: {
                    unsafe fn serialize_field<T>(data: &mut Any,
                        k: &'static str, v: &dyn Serialize) -> Result<(), Error>
                        where T: serde::ser::SerializeStruct {
                        unsafe {
    ...
    impl<'a> SerializeStruct for Struct<'a> {
        type Ok = Ok;
        type Error = Error;
        fn serialize_field<T>(&mut self, name: &'static str, field: &T)
            -> Result<(), Error> where T: ?Sized + serde::Serialize {
        ...
        unsafe fn new<T>(data: T) -> Self where
            ...
            StructVariant {
                ...
                serialize_field: {
                    unsafe fn serialize_field<T>(data: &mut Any,
                        k: &'static str, v: &dyn Serialize) -> Result<(), Error>
                        where T: serde::ser::SerializeStructVariant {
                        unsafe {
                            data.view::<T>().serialize_field(k, v).map_err(erase)
                        }
                    }
    ...
    impl<'a> Serializer for Box<dyn Serializer + 'a> {
        ...
        fn erased_serialize_unit_variant(&mut self, name: &'static str,
            variant_index: u32, variant: &'static str) -> Result<Ok, Error> {
            (**self).erased_serialize_unit_variant(name, variant_index,
                variant)
        }
        fn erased_serialize_newtype_struct(&mut self, name: &'static str,
            v: &dyn Serialize) -> Result<Ok, Error> {
        ...
        fn erased_serialize_tuple_variant(&mut self, name: &'static str,
            variant_index: u32, variant: &'static str, len: usize)
            -> Result<TupleVariant, Error> {
            (**self).erased_serialize_tuple_variant(name, variant_index,
                variant, len)
        }
        fn erased_serialize_map(&mut self, len: Option<usize>)
            -> Result<Map, Error> {
        ...
        fn erased_serialize_struct_variant(&mut self, name: &'static str,
            variant_index: u32, variant: &'static str, len: usize)
            -> Result<StructVariant, Error> {
            (**self).erased_serialize_struct_variant(name, variant_index,
                variant, len)
        }
        fn erased_is_human_readable(&self) -> bool {
            (**self).erased_is_human_readable()
    ...
    fn unerase<E>(e: Error) -> E where E: serde::ser::Error { E::custom(e) }
}
...
pub mod private {
    ...
    pub use serde;
    pub fn require_erased_serialize_impl<T>() where T: ?Sized +
        crate::Serialize {}
}
